...
const MINUS_ICON = IOS ? 'remove-circle' : 'remove-circle';
const TRASH_ICON = IOS ? 'trash' : 'trash';
const PLUS_ICON = IOS ? 'pluscircle' : 'md-add';
const CART_ICON = IOS ? 'shoppingcart' : 'shoppingcart';
const DELETE_ICON = IOS ? 'closecircle' : 'md-close';
const RATING_ICON = IOS ? 'star' : 'star';
...
const DeleteButton = ({ onPress }) => (
  <View style={styles.deleteButtonContainer}>
    <TouchableItem onPress={onPress} style={styles.deleteButton}>
      <AntDesign name="delete"size={26} color={Colors.white} />
    </TouchableItem>
  </View>
);
                ...
                <View style={styles.productInfo}>
                  ...
                  <View style={styles.viewContainer}>
                    <View style={styles.starContainer}>
                      ...
                      <Text style={styles.starText}>{rating} <AntDesign  name={RATING_ICON} size={12} color={Colors.onPrimaryColor} /></Text>}
                    </View>
